...
public class DisplayWallhealth : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        maxHealth = (int)sceneWallDamage.wallHealth; //sets max health at the beginning of the scene. Since there isn't a max health variable for some reason, just grab the health as the object is made.
        currentHealth = (int)sceneWallDamage.wallHealth; // do the same for current health when the scene is created.
    }
